...
export default function Hero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Single optimized timeline for better performance
  ...
  return (
    <div ref={mainRef} className=" relative w-full h-[100vh] overflow-hidden">

      {/* hero first */}
      <div
        className="h-screen max-w-7xl mx-auto pt-52 flex relative"
      >
        <div ref={sectionRef} className="w-full grid grid-cols-2 ">
        ...
        <div ref={rightRef} className="w-full max-w-xl line-clamp-3 text-lg">
      ...
      {/* hero second */}
      <section ref={rightRef} className="min-h-screen absolute top-0 left-0 w-full translate-y-full text-white  gap-14 z-[60] flex flex-col justify-center items-center">
      ...
      <div
        ref={imageRef}
        className="absolute top-1/2 max-w-screen h-[150dvh] w-full z-[50] pointer-events-none"
      >
