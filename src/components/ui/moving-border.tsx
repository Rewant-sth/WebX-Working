    ...
    return (
        <div className="">
            ...
            >
                ...
                />
                <div className="relative z-1 border text-foreground text-center text-base py-3 px-6 rounded-sm bg-white border-orange-500/30 hover:border-orange-400/50 transition-colors dark:from-gray-900 dark:to-gray-800 dark:border-orange-400/40 text-orange-500 uppercase font-semibold">
                    {children}
                </div>
            </Component>
        </div>
