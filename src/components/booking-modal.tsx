...
import { getPackage, getSelectedFixedDateId } from "@/store/booking-store";
import Link from "next/link";
import BookingFormSkeleton from "@/app/booking/[id]/_components/Skeleton";
...
export default function BookingModal() {
    ...
    const { childrenCount, totalAmount, originalAmount, discountPercentage, discountAmount } = useMemo(() => {
