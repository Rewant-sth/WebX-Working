    ...
    <div>
      ...
      >
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h3 className="text-6xl font-bold mb-12 text-gray-800">Our Mission</h3>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 mt-16">
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-700">5 Continents</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-700">50+ Mountain Ranges</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-700">10,000+ Trekkers Guided</span>
            </div>
          </div>
        </div>
      </div>
