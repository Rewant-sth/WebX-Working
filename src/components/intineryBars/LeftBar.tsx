        ...
        <ul className="flex flex-col">
          ...
          {data?.tripHighlight && data.tripHighlight.length > 0 ? (
            <li
              ...
              className={`flex items-center gap-2 px-2 py-1 rounded-md cursor-pointer transition-all duration-300 text-sm ${isActive("trip-highlight")
                ? "bg-blue-50 text-blue-500 font-medium"
                : "hover:translate-x-1"
                }`}
            >
