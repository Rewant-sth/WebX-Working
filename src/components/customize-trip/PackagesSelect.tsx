...
export default function PackagesSelect({
    ...
    return (
        <div className="space-y-6">
            {/* Search Bar */}
            <div className="flex justify-between gap-10 border-b pb-4 border-zinc-200
            ">
                <div className="">
                ...
                <div className="relative h-fit">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border border-zinc-300 rounded-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
                    />
                </div>
            </div>
