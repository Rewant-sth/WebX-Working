...
const TestimonialsSections = () => {
  ...
  return (
    <section className="min-h-screen h-full  snap-start">
      <div className="grid grid-cols-8 gap-4 px-6 py-10 pt-10">
      ...
      <div className="flex flex-col gap-6 justify-center -translate-y-44 items-center">
        <span className="bg-gray-100 px-4 text-gray-800 rounded-full">Testimonials</span>
        <h2 className="text-4xl text-center font-semibold max-w-lg"><span className="bg-orange-500 text-white px-2">Preferred</span> by  thousands  around the <span className="bg-orange-500 text-white px-2">world</span></h2>
