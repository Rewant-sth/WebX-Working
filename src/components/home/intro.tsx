...
export default function Intro() {
    ...
    return (
        <section ref={containerRef} className="min-h-screen flex justify-center items-center h-full relative  snap-start px-4 md:px-0">
            ...
            >
                <div className="w-full max-w-2xl flex flex-col gap-6 md:gap-12 items-start ">
                    <div className="max-w-2xl w-full md:space-y-1.5 text-2xl md:text-5xl font-semibold">
                ...
                <div className="pt-6 md:pt-2 space-y-5">
                    <motion.p
