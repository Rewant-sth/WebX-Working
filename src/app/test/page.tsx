        ...
        <section className="absolute z-[999999]  backdrop-blur-md inset-0 h-full bg-black/40   min-h-screen w-full lg:flex justify-center items-center ">
            <div className="w-full h-full  relative">
                ...
                <div className="lg:sticky top-4 lg:top-8 relative   w-full  ">
                    ...
                    >
                        <button onClick={onClose} className=" flex justify-end items-center">
                            <X />
                        </button>
                                    ...
                                    {!isSubmitted ? (
                                        ...
                                        >
                                            ...
                                            <motion.button
                                                ...
                                                className="px-6 py-2 bg-white/[0.08] border border-black/[0.15] rounded-sm  hover:bg-white/[0.12] transition-all"
