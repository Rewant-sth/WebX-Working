...
const values = [
  {
    icon:
      <svg xmlns="http://www.w3.org/2000/svg" width="2.2em" height="2.2em" viewBox="0 0 1024 1024">
  ...
  return (
    <main >
      <section className="grid p-6 pb-10 grid-cols-7 gap-6 h-[85dvh]">
        ...
        <div className="col-span-2 grid grid-rows-2   ">
          ...
          <div className="py-6">
            ...
            <h2 className="font-semibold mt-6">Certifications</h2>
            <div className="flex gap-4 mt-2 items-center">
              <span className="bg-gray-200 px-2 py-0.5 rounded-sm">UIAA Certified</span>
              <span className="bg-gray-200 px-2 py-0.5 rounded-sm">NMA Licensed</span>
              <span className="bg-gray-200 px-2 py-0.5 rounded-sm">Wilderness First Aid</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="p-6 py-10">
        <div className=" p-8 grid grid-cols-5 gap-10 bg-gray-100">
          <div className="col-span-3 h-full w-full  rounded-sm   leading-snug">
          ...
          <div className="col-span-2 gap-4 grid grid-rows-3">
            {values?.slice(0, 3).map((item, idx) => (
              <div className="flex relative text-white items-center gap-4 rounded-sm overflow-hidden " key={idx}>
                <div className="absolute inset-0">
                  <div className="h-full w-full relative">
                    <Image src={"/EVEREST REGION/NIKON D50015520.jpg"} fill alt="Core Principle" className="object-cover  rounded-sm" />
                  </div>
                </div>
                <div className="relative bg-gradient-to-b from-orange-500/30 to-orange-800/50 p-4">
                  <div>
