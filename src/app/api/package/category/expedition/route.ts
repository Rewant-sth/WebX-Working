...
export async function GET(request: NextRequest) {
    try {
        ...
        const apiUrl = `${BACKEND_API_URL}/package/category/expedition${queryString ? `?${queryString}` : ''}`;
        ...
        console.error('Error fetching expedition packages:', error);

        return NextResponse.json(
            {
                status: 'error',
                message: 'Failed to fetch expedition packages',
